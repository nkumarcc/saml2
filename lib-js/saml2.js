...
parse_authn_response = function(saml_response, sp_private_keys, idp_certificates, allow_unencrypted, ignore_signature, require_session_index, cb) {
  ...
  if (!ignore_signature) {
    ...
    for (j = 0, len = ref1.length; j < len; j++) {
      ...
      if ((signed_data_from_complete_saml_response != null ? signed_data_from_complete_saml_response.length : void 0) === 1) {
  ...
  return async.waterfall([
    function(cb_wf) {
      ...
      var assertion_attributes, err, issuer, issuerNode, ref2, session_info;
      try {
